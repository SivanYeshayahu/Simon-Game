...
$(document).keypress(function() {
    if (!started) { //true
        ...
        $("#level-title").text("Level " + level); // show the sign
...
$(".btn").click(function() {
    ...
    ///// to try on concle is gonna add the button that i press on them console.log(userClickedPattern);
    ...
    animatePress(userChosenColour); //become grey 
...
function nextSequence() {
    ...
    // add the new  cosen color to th empty erray
...
function playSound(name) {
    // Javascript to play the sound for the button colour selected in step 1.
...
function animatePress(currentColour) {
    // pressed changes the background colour to grey.
